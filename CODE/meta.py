...
#GUI
root = Tk()
root.title("Deon Chris")
#ICON
root.iconbitmap("./assets/dc.ico")
...
#BUTTON PROP  
b1 = Button(canvas,text = "Content Ratings",command = Content_Rating,activeforeground = "red",activebackground = "pink",pady=10, height=1, width=15, anchor='n')  
  
b2 = Button(canvas, text = "Trend",command=Trend, activeforeground = "blue",activebackground = "pink",pady=10, height=1, width=15, anchor='n')  
  
b3 = Button(canvas, text = "Top Directors", command=Top_Directors, activeforeground = "green",activebackground = "pink",pady = 10, height=1, width=15, anchor='n')  
  
b4 = Button(canvas, text = "Top 5 Actors", command=Top_Actors, activeforeground = "yellow",activebackground = "pink",pady = 10, height=1, width=15, anchor='n')  

b5 = Button(canvas, text = "Sentiment Analysis", command=Sentiment, activeforeground = "yellow",activebackground = "pink",pady = 10, height=1, width=15, anchor='n')
